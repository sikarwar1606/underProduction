...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="BreakDownSecureHyderabad.css" />
    <link
      rel="stylesheet"
  ...
  <div class='navbar'>
    ...
    <div class="RunningProduction" >
      <div class="nav_running_production">
        <h3 id="hrp">BreakDown</h3>
      </div>
      <div id="container_running_production">
        <table id="realTimeRunningProduction">
          <thead>
            <th class="headTableDataForRp"><p class="headingOfTable">M/C No. </p></th>
            <th class="headTableDataForRp"><p class="headingOfTable">Reason </p></th>
            <th class="headTableDataForRp"><p class="headingOfTable">Status </p></th>
            <th class="headTableDataForRp"><p class="headingOfTable">Date </p></th>
            <th class="headTableDataForRp"><p class="headingOfTable">Time </p></th>
            <th class="headTableDataForRp"><p class="headingOfTable">Breakdown Time </p></th>
